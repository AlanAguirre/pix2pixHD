...
class BaseOptions():
    ...
    def initialize(self):    
        ...
        self.parser.add_argument('--resize_or_crop', type=str, default='scale_width', help='scaling and cropping of images at load time [resize_and_crop|crop|scale_width|scale_width_and_crop|dynamic]')
        ...
        self.parser.add_argument('--self_attn_kernel', type=int, default=0, help='Self-Attention size to be calculated, 0 means no self-attention layer')        
